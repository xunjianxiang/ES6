...
/***/ function(module, exports, __webpack_require__) {
	...
	// import './myGenerator'
	_location2.default.route = _route2.default;
	...
	
	{
		(function () {
				...
				return _regenerator2.default.wrap(function Gen$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								flag = true;
								return _context.delegateYield(random(flag), 't0', 2);
	
							case 2:
								a = _context.t0;
								return _context.delegateYield(round(a), 't1', 4);
			...
			var random = _regenerator2.default.mark(function random(flag) {
				return _regenerator2.default.wrap(function random$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								return _context2.abrupt('return', flag ? Math.random() : 1);
			...
			var round = _regenerator2.default.mark(function round(number) {
				return _regenerator2.default.wrap(function round$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								return _context3.abrupt('return', Math.round(number));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _co = __webpack_require__(96);
		...
		(0, _createClass3.default)(MainPage, [{
					...
					return _regenerator2.default.wrap(function _callee$(_context) {
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									_context.next = 2;
									return _http2.default.ajax.apply(_http2.default, (0, _toConsumableArray3.default)(_route.data));
	
								case 2:
									data = _context.sent;
									_context.next = 5;
									return (0, _render2.default)('mainTemplate', data);
	
								case 5:
									_this.operate();
									return _context.abrupt('return', 'get in main');
			...
			value: function operate() {
				document.querySelector('button').addEventListener('click', function (event) {
					_location2.default.assign('/error');
	...
	var Loader = (function () {
		...
		(0, _createClass3.default)(Loader, [{
			...
			value: function xhr(options) {
				...
				var cache = _options$cache === undefined ? true : _options$cache;
				...
				var promise = new _promise2.default(function (success, failure) {
					...
					if (method.toUpperCase() === 'GET' && data && (0, _stringify2.default)(data).length > 2) {
						url += url.includes('?') ? '&' : '?';
			...
			value: function ajax() {
				...
				for (var _len = arguments.length, ajaxArr = Array(_len), _key = 0; _key < _len; _key++) {
					ajaxArr[_key] = arguments[_key];
				}
	
				var promises = ajaxArr.map(function (item) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		change: function change() {
			// this.changeCallback()
			var _path = this.path();
			var _pathObj = this.pathFormat();
			this.load(_pathObj);
		},
		pathFormat: function pathFormat() {
			var _this = this;
			var _obj = {
				path: '',
			...
			if (_this.route[path]) {
				...
				if (_this.route[_obj.path]) _obj.params = path.substring(path.lastIndexOf('/') + 1);else _obj.path = '/error';
			}
			return _obj;
		},
		load: function load(_route) {
			var _this = this;
			var result = {
				path: _route.path,
				data: [{
					...
					cache: false
				}].concat((0, _toConsumableArray3.default)(_this.route[_route.path].data))
			};
			_this.route[_route.path].entry.init(result);
		},
		urlParamsFormat: function urlParamsFormat(url) {
			var result = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (el, data) {
		var templateStr = '';
		var templateData = {};
		data.map(function (item) {
			if (typeof item === 'string') {
				...
				(0, _assign2.default)(templateData, item);
			}
		});
		var promise = new _promise2.default(function (success) {
			document.querySelector('#main').innerHTML = templateStr;
			var _html = $template(el, templateData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Gen) {
		var promise = new _promise2.default(function (success, failure) {
			var gen = new Gen();
			function next(data) {
				var current = data ? gen.next(data) : gen.next();
				// 如果current.value并不是一个Promise对象,将他转化成一个Promise对象
				current.value = current.value instanceof _promise2.default ? current.value : _promise2.default.resolve(current.value);
				if (!current.done) {
					current.value.then(function (_data) {
						next(_data);
					}).catch(function (error) {
						...
						while (1) {
							switch (_context.prev = _context.next) {
								...
								case 2:
									data = _context.sent;
									_context.next = 5;
									return (0, _render2.default)('errorTemplate', data);
